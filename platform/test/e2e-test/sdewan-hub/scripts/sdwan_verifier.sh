...
echo "Get MWAN3 policies ..."
policies=$(call_get http://$sdwan_pod_ip/cgi-bin/luci/sdewan/mwan3/v1/policies $security_token)
echo $policies
...
rule="
{
    ...
    \"connections\":[{
        ...
        \"type\":\"tunnel\",
        \"mode\":\"start\",
        \"remote_sourceip\":\"192.168.1.5-192.168.1.15\",
...
{
echo "Cleaning ..."
echo $(call_delete http://$sdwan_pod_ip/cgi-bin/luci/sdewan/ipsec/v1/sites/edgeC $security_token)
echo $(call_delete http://$sdwan_pod_ip/cgi-bin/luci/sdewan/ipsec/v1/proposals/my_test_proposal1 $security_token)
}
echo "Test Completed!"
